  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-4">
      <div className="relative flex-center size-full">
        <div className="size-full max-w-[1000px] items-center">
          <CallLayout />
        </div>
        <div className={cn("h-[calc(100vh-86px)] hidden ml-2", { "show-block": showParticipants })}>
          <CallParticipantsList onClose={() => setShowParticipants(!showParticipants)} />
        </div>
      </div>
      ...
      <div className="fixed bottom-0 flex-center gap-5 w-full flex-wrap">
        ...
        <DropdownMenu>
          <div className="flex items-center">
            <DropdownMenuTrigger className="call-btn-style">
              <LayoutList size={23} />
            </DropdownMenuTrigger>
          </div>
          <DropdownMenuContent className="border-dark-1 glassmorphism2">
        ...
        <CallStatsButton />
        <button className="call-btn-style"
